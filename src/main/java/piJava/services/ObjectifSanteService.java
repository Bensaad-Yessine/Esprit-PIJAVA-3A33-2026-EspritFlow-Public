...
public class ObjectifSanteService {
    ...
    private final boolean archiveEmailSentAtExists;
    ...
    public ObjectifSanteService() {
        ...
        archiveEmailSentAtExists = verifierPresenceColonneArchiveEmailSentAt();
    }
    ...
    public List<ObjectifSante> recuperer() throws SQLException {
        ...
        String sql = "SELECT o.id, o.titre, o.type, o.valeur_cible, o.date_debut, o.date_fin, " +
                ...
                "o.share_expires_at, " + archiveEmailSentAtSelect() + ", " +
    ...
    private void envoyerEmailArchive(ObjectifSante objectif) throws Exception {
        ...
        boolean emailEnvoye = brevoEmailService.sendPdfWithAttachment(
                toEmail,
    ...
    public void desarchiverObjectif(int objectifId) throws SQLException {
        String sql = "UPDATE objectif_sante " +
                "SET archived_at = NULL, archive_pdf_path = NULL, " +
                (archiveEmailSentAtExists ? "archive_email_sent_at = NULL, " : "") +
                "statut = 'EN_COURS' " +
                "WHERE id = ?";
        PreparedStatement ps = cnx.prepareStatement(sql);
        ps.setInt(1, objectifId);
    ...
    private String archiveEmailSentAtSelect() {
        return archiveEmailSentAtExists ? "o.archive_email_sent_at" : "NULL AS archive_email_sent_at";
    }

    private boolean verifierPresenceColonneArchiveEmailSentAt() {
        try {
            DatabaseMetaData metaData = cnx.getMetaData();
            try (ResultSet rs = metaData.getColumns(cnx.getCatalog(), null, "objectif_sante", "archive_email_sent_at")) {
                return rs.next();
            }
        } catch (SQLException e) {
            System.out.println("Impossible de vérifier la colonne archive_email_sent_at: " + e.getMessage());
            return false;
        }
    }
