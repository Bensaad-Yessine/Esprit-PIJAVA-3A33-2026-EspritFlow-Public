...
public class WorkoutApiExerciseClient {
    ...
    public List<ExerciceSport> chercherExercices(String bodyPart, String equipment) throws IOException, InterruptedException, org.json.JSONException {
    ...
    private List<ExerciceSport> convertirReponse(String body, String bodyPart, String equipment) throws org.json.JSONException {
