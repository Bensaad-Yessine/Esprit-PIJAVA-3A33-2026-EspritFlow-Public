...
public class AjouterSuiviController {
    ...
    public void ajouterSuivi() {
        ...
        try {
            ...
            ObjectifSante objectif = objectifService.recupererParId(objectifId);

            if (objectif == null) {
                errDateSaisie.setText("Objectif introuvable pour calculer le score.");
                return;
            }
            ...
            SuiviBienEtre suivi = new SuiviBienEtre(
                    Date.valueOf(dpDateSaisie.getValue()),
                    cbHumeur.getValue(),
                    qualiteSommeil,
                    niveauEnergie,
                    niveauStress,
                    qualiteAlimentation,
                    txtNotesLibres.getText() == null ? "" : txtNotesLibres.getText().trim(),
                    score,
                    objectifId
            );

            SuiviBienEtreService service = new SuiviBienEtreService();
            service.ajouter(suivi);
